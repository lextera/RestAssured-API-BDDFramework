...
public class RestUtilities {
	...
	public static RequestSpecification getRequestSpecification(){
		...
		REQUEST_BUILDER.setProxy("192.168.3.89",3128);
		...
		REQUEST_BUILDER.setBody("{\"cookie_id\":\"93A64060B1A84BF3B287FF0B72136BBA:Lex:4EC72ED6ABEC3F4F4D868D871B2BB30C\",\"order_id\":\"M16B2E9DBCFC\"}");
	...
	public static Response getResponse(RequestSpecification reqSpec, String type) {
		...
		response.then().spec(RESPONSE_SPEC); // validation basic reqs
		return response;
	}
